...
// you can add more buttons with "dataCollector" to gather more data!
 ...
 *
 * ?MobileNet is a family of deep neural network architectures designed for
 * efficient on-device computer vision tasks, particularly on mobile and embedded devices.
 * These architectures are optimized for mobile and edge computing scenarios
 * where computational resources, memory, and power consumption are limited.
 **/
async function loadMobileNetFeatureModel() {
    const URL =
        "https://tfhub.dev/google/tfjs-model/imagenet/mobilenet_v3_small_100_224/feature_vector/5/default/1";
    // loading graph model from the url
    mobilenet = await tf.loadGraphModel(URL, {
        fromTFHub: true,
    });
    // showing status after loading
    STATUS.innerText = "MobileNet v3 loaded successfully!";

    // Warm up the model by passing zeros through it once.
    // ?A technique that can help improve the efficiency and accuracy of the model's predictions
    tf.tidy(function () {
        ...
        // logging the shape of the answer tensor to the console
        ...
        navigator.mediaDevices
            ...
            .then(function (stream) {
                ...
                VIDEO.addEventListener(
                    ...
                    function () {
                        videoPlaying = true;
                        ENABLE_CAM_BUTTON.classList.add(
                            "removed"
                        );
                    }
                );
